...
module Rubyrana
  module Providers
    class Base
      def complete(prompt: nil, messages: nil, tools: [], **opts)
        raise NotImplementedError, 'Provider must implement #complete'
      end

      def stream(prompt: nil, messages: nil, tools: [], **)
        result = complete(prompt: prompt, messages: messages, tools: tools, **)
      ...
      def structured_output(schema:, prompt: nil, messages: nil, tools: [], tool_name: nil, **)
