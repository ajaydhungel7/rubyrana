...
class A2AAgentTest < Minitest::Test
  ...
  def test_init_with_name_and_description
    agent = Rubyrana::A2A::Agent.new(endpoint: 'http://localhost:8000', name: 'my-agent',
  ...
  def test_invoke_success
    ...
    message = Rubyrana::A2A::Message.new(message_id: '1', role: 'agent',
                                         parts: [Rubyrana::A2A::TextPart.new(kind: 'text', text: 'Response')])
